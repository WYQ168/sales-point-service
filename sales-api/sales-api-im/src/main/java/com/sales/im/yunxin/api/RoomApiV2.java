 ...
 * @date 2022/7/4 17:48
 */
public class RoomApiV2 {
    private static Logger logger = LoggerFactory.getLogger(RoomApiV2.class);
    /**
     * 创建聊天室
     * @return
     * @throws IOException
     */
    public static String roomCreate(RoomCreate roomCreate, YunXinConfig yunXinConfig) throws IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        List<NameValuePair> params = Reflect.reflectTest(roomCreate);
        //UTF-8编码,解决中文问题
        HttpEntity entity = new UrlEncodedFormEntity(params, "UTF-8");
        String res = NIMPost.postNIMServer(UrlConst.ROOM_CREATE_URL, entity, yunXinConfig.getAppKey(), yunXinConfig.getAppSecret());
