...
import com.sales.im.yunxin.bean.*;
 ...
 * @date 2022/7/4 17:48
 */
public class AudioVideoApi {
    private static Logger logger = LoggerFactory.getLogger(AudioVideoApi.class);
    /**
     * 创建音视频令牌
     * @return
     * @throws IOException
     */
    public static String createNERTCToken(GetToken getToken, YunXinConfig yunXinConfig) throws IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        List<NameValuePair> params = Reflect.reflectTest(getToken);
        //UTF-8编码,解决中文问题
        HttpEntity entity = new UrlEncodedFormEntity(params, "UTF-8");
        String res = NIMPost.postNIMServer(UrlConst.GET_TOKEN_URL, entity, yunXinConfig.getAppKey(), yunXinConfig.getAppSecret());
        logger.info("createNERTCToken httpRes: {}", res);
        return res;
    }
