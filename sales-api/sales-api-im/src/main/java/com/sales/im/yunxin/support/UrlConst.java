...
public class UrlConst {
    ...
    //获取音视频通讯令牌token
    public static String GET_TOKEN_URL = "https://api.netease.im/nimserver/user/getToken.action";
     ...
     */
    //创建房间
    public static String ROOM_CREATE_URL = "https://logic-dev.netease.im/v2/api/room";
