package com.sales.app.utils.unionpay.sdk.gm;

import com.sales.app.utils.unionpay.sdk.Acp6Service;
import com.sales.app.utils.unionpay.sdk.SDKConstants;
...
public class GmAcp6Service {
	...
	public static Map<String, String> signByCertInfo(Map<String, String> reqData, String certPath, 
        ...
        Map<String, String> data = com.sales.app.utils.unionpay.sdk.SDKUtil.filterBlank(reqData);

        if (com.sales.app.utils.unionpay.sdk.SDKUtil.isEmpty(encoding)) {
            encoding = "UTF-8";
        }
        
        if (com.sales.app.utils.unionpay.sdk.SDKUtil.isEmpty(certPath) || com.sales.app.utils.unionpay.sdk.SDKUtil.isEmpty(certPwd)) {
	...
	public static String encryptPin(String accNo, String pin, String encoding) {
		byte[] pinblock = com.sales.app.utils.unionpay.sdk.SecureUtil.pinblock(accNo, pin); //pinblock算法确认过和国际一致
